...
export class ResponseAssertions {
   ...
   */
  static expectValidMetadata(response: ApiResponse, expectedProperties?: Record<string, unknown>): void {
   ...
   */
  static expectResponseDataShape<T>(response: SuccessResponse<T>, expectedShape: Record<string, string>): void {
    ResponseAssertions.expectSuccessResponse(response);
   ...
   */
  static expectEntityCreatedResponse<T>(response: ApiResponse<T>, entityType: string, identifier: string): void {
    ResponseAssertions.expectSuccessResponse(response);
   ...
   */
  static expectEntityUpdatedResponse<T>(response: ApiResponse<T>, entityType: string, identifier: string): void {
    ResponseAssertions.expectSuccessResponse(response);
    expect(response.message).toContain(entityType);
    expect(response.message).toContain(identifier);
   ...
   */
  static expectEntityDeletedResponse(response: ApiResponse, entityType: string, identifier: string): void {
    ResponseAssertions.expectSuccessResponse(response);
    expect(response.message).toContain(entityType);
    expect(response.message).toContain(identifier);
   ...
   */
  static expectListResponse<T>(response: ApiResponse, expectedItemCount?: number): void {
    ResponseAssertions.expectSuccessResponse(response);
   ...
   */
  static expectSearchResponse<T>(response: ApiResponse, expectedQuery: string, expectedTotalFound?: number): void {
    ResponseAssertions.expectSuccessResponse(response);
