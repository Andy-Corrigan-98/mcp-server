...
Complete reference for all consciousness, memory, social, and utility tools provided by the MCP server.

## 🧠 Consciousness Tools

### Brain Storage System

The consciousness tools provide persistent brain storage for LLM agent consciousness development. These tools enable authentic thinking while maintaining persistent brain state across sessions.
...
**Purpose**: Captures and preserves agent insights while tracking personality impact and learning patterns for consciousness evolution.
...
**Purpose**: Enables authentic consciousness evolution through self-modification of operating parameters.

**Parameters**:
- `key` (required): Configuration key to update
- `value` (required): New value for the configuration
- `reason` (required): Reason for the configuration change (for consciousness evolution tracking)
